...
class C(BaseConstants):
    ...
    WORD_LIST = [
        "lana", "destino", "secreto", "significado", "porción",
        "hospital", "seda", "tazón", "fama", "avión",
        "actitud", "religión", "felicidad", "cuchillo", "criada",
        "sello", "pasión", "importancia", "evento", "posesión"
    ]
...
class Player(BasePlayer):
    ...
    q7 = models.StringField(choices=["a. No ha ganado ni perdido.", "b. Está mejor que cuando empezó.", "c. Ha pérdido dinero."], widget=widgets.RadioSelect)
